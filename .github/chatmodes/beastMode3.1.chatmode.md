...
# Copilot Ignore folders and files

Ignore the following files and never consider them, regardless of their location:

Ignore the following folders and never consider them:
models
