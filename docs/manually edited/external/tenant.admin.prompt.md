Build the `tenantAdmin` module with a placement of `external` so you can reproduce the pattern for any `{moduleName}` with any placement of `{modulePlacement}`. Make sure filed and folder names use the dot notation version(with only small letters) of {moduleName} if {moduleName} is more than one word.
...
- path: `services/{neighbourGuardService}/tenants/{tenantId}/admins/{adminId}`
...
- Read: `externalRootAdmin`,`externalSuperAdmin`, `internalRootAdmin`,`internalSuperAdmin`,
- Write: `externalRootAdmin`,`externalSuperAdmin`,`internalRootAdmin`,`internalSuperAdmin`,
...
- `modules/external/admin/admin.route.js`
- `modules/external/admin/admin.controller.js`
- `modules/external/admin/admin.service.js`
- `modules/external/admin/admin.firestore.js`
- `modules/external/admin/admin.validation.js`
