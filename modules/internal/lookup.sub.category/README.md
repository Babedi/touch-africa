...
Complete CRUD API module for managing lookup sub categories in the NeighbourGuard system. This module follows the established architectural patterns and provides full functionality for subcategory management.
