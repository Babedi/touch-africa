...
The Lookup Category module provides CRUD operations for managing lookup categories in the NeighbourGuard system. This module follows the established modular architecture pattern and includes comprehensive validation, authentication, and authorization.
...
**Collection Path:** `services/neighbourGuardService/lookupCategory`
