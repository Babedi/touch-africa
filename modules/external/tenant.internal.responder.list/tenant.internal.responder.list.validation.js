...
export const TenantInternalResponderListSchema = z.object({
...
export const TenantInternalResponderListUpdateSchema =
  TenantInternalResponderListSchema.partial();

export const ResponderIdSchema = z
  .string()
  .regex(idRegex, "id must be of format RSPNDR{timestamp}");

export function newTenantInternalResponderListId() {
