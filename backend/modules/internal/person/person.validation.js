...
const DemographicsSchema = z.object({
  ...
  employment: z.object({
    ...
    company: z.string().min(1, "Company name is required"), // Made required
    position: z.string().min(1, "Position is required"), // Made required
    industry: z.string().min(1, "Industry is required"), // Made required
    monthlyIncome: z.string().min(1, "Monthly income is required"), // Made required
  }),
  education: z.object({
    level: z.enum(
      [
    ...
    institution: z.string().min(1, "Institution is required"), // Made required
    fieldOfStudy: z.string().min(1, "Field of study is required"), // Made required
    graduationYear: z.string().min(1, "Graduation year is required"), // Made required
  }),
  disability: z.object({
...
const BasePersonSchema = z.object({
  ...
  preferredName: z.string().min(1, "Preferred name is required"), // Made required
