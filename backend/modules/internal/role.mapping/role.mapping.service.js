 ...
 */
export const createRoleMappingService = async (roleMappingData, actor) => {
  ...
  return await createRoleMapping(roleMappingWithMetadata);
};

/**
 * Get role mapping by ID
 */
export const getRoleMappingByIdService = async (mappingId) => {
  return await getRoleMappingById(mappingId);
};

/**
 * Get role mapping by name
 */
export const getRoleMappingByNameService = async (roleName) => {
  return await getRoleMappingByName(roleName);
};
...
export const updateRoleMappingByIdService = async (
  ...
  const result = await updateRoleMappingById(mappingId, dataWithMetadata);

  // Update in-memory config if roleCode was changed
  if (updateData.roleCode) {
    const mapping = await getRoleMappingById(mappingId);
    if (mapping) {
 ...
 */
export const deleteRoleMappingByIdService = async (mappingId) => {
  // Get the mapping first to update config
  const mapping = await getRoleMappingById(mappingId);

  const result = await deleteRoleMappingById(mappingId);
 ...
 */
export const getAllRoleMappingsService = async () => {
  const dbMappings = await getAllRoleMappings();
...
export const syncRoleMappingsService = async (actor) => {
  ...
  return await getAllRoleMappingsService();
};
...
export const getRoleCodeByNameService = async (roleName) => {
  const mapping = await getRoleMappingByName(roleName);
...
export const bulkCreateRoleMappingsService = async (
  ...
  for (const mappingData of mappingsData) {
    try {
      const existing = await getRoleMappingByName(mappingData.roleName);
...
export async function listRoleMappingsService(queryParams = {}) {
  try {
    ...
    const roleMappings = await getAllRoleMappings();
