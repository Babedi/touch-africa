...
} from "./standard.role.mapping.validation.js";
import {
  createStandardRoleMappingService,
  getStandardRoleMappingByIdService,
  updateStandardRoleMappingByIdService,
  deleteStandardRoleMappingByIdService,
  getAllStandardRoleMappingsService,
  reloadRoleMappingsService as reloadStandardRoleMappingsService,
  listRoleMappingsService as listStandardRoleMappingsService,
  searchRoleMappingsService as searchStandardRoleMappingsService,
  bulkRoleMappingsService as bulkStandardRoleMappingsService,
  exportRoleMappingsService as exportStandardRoleMappingsService,
  getRoleMappingsStatsService as getStandardRoleMappingsStatsService,
} from "./standard.role.mapping.service.js";
import {
  sendSuccess,
  sendError,
  sendValidationError,
...
/**
 * Get current standard role mappings with comprehensive query support
 */
export const getStandardRoleMappings = async (req, res) => {
  try {
    const result = await listStandardRoleMappingsService(req.query);

    return sendSuccess(
      res,
      result.data,
      "Standard role mappings retrieved successfully",
      200,
      result.pagination
    );
  } catch (error) {
    console.error("Error getting standard role mappings:", error);
    return sendError(
      res,
      "FETCH_FAILED",
      "Failed to get standard role mappings",
      null,
      500
    );
  }
 ...
 */
export const searchStandardRoleMappings = async (req, res) => {
  try {
 ...
 */
export const bulkStandardRoleMappings = async (req, res) => {
  try {
 ...
 */
export const exportStandardRoleMappings = async (req, res) => {
  try {
 ...
 */
export const getStandardRoleMappingsStats = async (req, res) => {
  try {
 ...
 */
export const updateStandardRoleMappings = async (req, res) => {
  try {
 ...
 */
export const reloadStandardRoleMappings = async (req, res) => {
  try {
 ...
 */
export const addStandardRoleMapping = async (req, res) => {
  try {
 ...
 */
export const removeStandardRoleMapping = async (req, res) => {
  try {
 ...
 */
export const getStandardRoleMappingById = async (req, res) => {
  try {
    const { id } = req.params;
 ...
 */
export const updateStandardRoleMappingById = async (req, res) => {
  try {
    const { id } = req.params;
 ...
 */
export const patchStandardRoleMappingById = async (req, res) => {
  try {
    const { id } = req.params;
